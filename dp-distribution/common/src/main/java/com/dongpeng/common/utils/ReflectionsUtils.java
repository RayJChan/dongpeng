...
public class ReflectionsUtils {
    ...
    public static List<Map<String ,Object>> compareTwoClass(Object class1, Object class2) throws ClassNotFoundException, IllegalAccessException {
        ...
        for(int i=0;i<field1.length;i++) {
            DataName dataName=field1[i].getAnnotation(DataName.class);
            //只有DataName 注解的字段才记录
            if(dataName!=null){
                //遍历属性列表field2
                for (int j = 0; j < field2.length; j++) {
                    ...
                    if (field1[i].getName().equals(field2[j].getName())) {
                        ...
                        if (null!=field2[j].get(class2) && !compareTwo(field1[i].get(class1), field2[j].get(class2))) {
                            Map<String, Object> map2 = new HashMap<String, Object>();

                            String fieldName=dataName.value();//记录进日志的字段名称
    ...
    /**
     * 根据class获取其所有field，包括父类的
     * @param clazz
     * @return
     */
    public static List<Field> getClassGenricFields(final Class clazz){
        List<Field> fieldList = new ArrayList<>() ;
        Class tempClass =clazz;
        //当父类为null的时候说明到达了最上层的父类(Object类).忽略掉object类
    ...
    /**
     * 根据class获取其所有Method，包括父类的
     * @param clazz
     * @return
     */
    public static List<Method> getClassGenricMethods(final Class clazz){
