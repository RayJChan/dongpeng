...
public class CommonConfig implements WebMvcConfigurer {
    ...
    public RedissonClient redisson() {
        ...
        if (Strings.isNullOrEmpty(redissonPassword)) {
            config.useSingleServer().setAddress("redis://" + redissonAddress + ":"+redisPort);
        } else {
            config.useSingleServer().setAddress("redis://" + redissonAddress + ":"+redisPort).setPassword(redissonPassword);
        }
