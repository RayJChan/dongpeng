...
public class AppOrderDaoTest extends SpringTestCase{
    ...
    public void testGetOnePage4Distribute(){
		logger.info("=====================crown=========================");
    	List<OrderEntity> result = appOrderDao.getOnePage4Distribute("8100", "",null, 1, 50,"");
    ...
    public void testGetOrderDetails(){
		...
		OrderEntity result = appOrderDao.getOrderDetails("60954680798");
		logger.info(JSON.toJSONString(result));
    }
    ...
    public void testGet2DistributeCount(){
		...
		Integer result = appOrderDao.get2DistributeCount("8100", "");
    	logger.info(JSON.toJSONString(result));
    }
    ...
    public void TestGetReturnRequestDetails(){
		...
		OrderEntity result = appOrderDao.getReturnRequestDetails("48942");
    	logger.info(JSON.toJSONString(result));
    }
    ...
    public void getPartOfReturnDetailsTest(){
		...
		List<OrderReturnEntity> result = appOrderDao.getPartOfReturnDetails("117778");
		logger.info(JSON.toJSONString(result));
    }
