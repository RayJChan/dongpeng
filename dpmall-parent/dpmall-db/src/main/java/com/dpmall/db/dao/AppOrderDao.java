...
import com.dpmall.db.bean.OrderListEntity;
...
public interface AppOrderDao {
	 ...
	 * 经销商接单
	 */
	public int acceptOfAgency(@Param("po") OrderDistributePo po);

	/**
	 * 经销商拒单
	 */
	public int rejectOfAgency(@Param("po")OrderDistributePo po);

	/**
	 * 门店接单
	 */
	public int acceptOfStore(@Param("po")OrderDistributePo po);
  ...
  /**
	 ...
	 */
	  ...
	  * 获取部分退货时，退货订单详情
	  */
	 public List<OrderReturnEntity> getPartOfReturnDetails(@Param("consignmentId") String consignmentId);
	 ...
	 * 编辑状态
	 */
	public int editStatus(@Param("po") OrderEditStatusPo po);
