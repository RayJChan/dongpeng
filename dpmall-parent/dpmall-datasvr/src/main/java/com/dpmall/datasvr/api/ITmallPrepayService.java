...
public interface ITmallPrepayService {
     ...
     * 获取列表（经销商）
     */
    List<TmallPrePayModel> getListOfAgency(String agencyId, String status, int pageNum, int pageSize, String search, String orderId, String clientName, String clientTel, String staRevisitTime, String endRevisitTime);

    /**
     * 获取列表（门店）
     */
    List<TmallPrePayModel> getListOfStore(String storeId, String status, int pageNum, int pageSize, String search, String orderId, String clientName, String clientTel, String staRevisitTime, String endRevisitTime);
     ...
     * 更新订单进度
     */
    int updateOrderProgress(String prePayId, String statusName, String agencyRemark, String failTypeId, String operatorBy, String isLoss, String orderEvaluation, String revisitTime);

    /**
     * 填写订单信息(提交)
     */
    int updateTmallOrderInfo(TmallOrderInfoModelIn form);

    /**
     * 填写订单信息(只保存不提交)
     */
    int saveSalOrderInfo(TmallOrderInfoModelIn form);
}
