...
//		params 格式：{"type":"SalesLeadsOrder",pk:"1111"}
		map.put("type","O2OConsignmentItems");//O2OConsignmentItems ,Consignment ,SalesLeadsOrder
		map.put("pk","8809724628580");
...
//		params 格式：{"code":"317716"}
	...
	@Test
	public void getHybrisToken() {
		String result = hybrisUtils.getHybrisToken();
		logger.info("\nresult:\n"+JSON.toJSONString(result)+"\n");
	}
