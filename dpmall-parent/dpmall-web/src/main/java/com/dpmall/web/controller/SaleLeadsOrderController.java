...
public class SaleLeadsOrderController {
    ...
    public Response getList4Agency(@RequestBody DistributeForm form) {
        ...
        try {
            ...
            res.data = saleLeadsOrderService.getList4Agency(form.agencyId, form.listStatus, form.pageNum, form.pageSize,form.search, form.orderId,form.clientName,form.clientTel,form.staRevisitTime,form.endRevisitTime,form.statusSearch);
     ...
     *
     */
    @RequestMapping(value = "/getList4AgencyOfUnHandle", method = {RequestMethod.GET, RequestMethod.POST}, produces = "application/json")
    @ResponseBody
    public Response getList4AgencyOfUnHandle(@RequestBody DistributeForm form) {
        LogUtil.controllerLogInfo("{method:'SaleLeadsOrderController::getList4AgencyOfUnHandle',in:" + JSON.toJSONString(form) + "}");
        Response res = new Response();
        try {
            if (StringUtils.isEmpty(form.agencyId) || form.pageNum == null || form.pageSize == null) {
                res.resultCode = ErrorCode.INVALID_PARAM;
                res.message = "参数错误";
                return res;
            }
            res.data = saleLeadsOrderService.getList4AgencyOfUnHandle(form.agencyId,form.pageNum, form.pageSize, form.search);
            res.resultCode = ErrorCode.SUCCESS;
        } catch (Exception e) {
            res.resultCode = ErrorCode.INTERNAL_ERR;
            res.message = "系统错误";
        ...
        LogUtil.controllerLogInfo("{method:'SaleLeadsOrderController::getList4AgencyOfUnHandle',in:" + JSON.toJSONString(res) + "}");
        return res;
    }
    ...
    public Response getList4Store(@RequestBody DistributeForm form) {
        ...
        try {
            ...
            res.data = saleLeadsOrderService.getList4Store(form.storeId, form.listStatus, form.pageNum, form.pageSize,form.search, form.orderId,form.clientName,form.clientTel,form.staRevisitTime,form.endRevisitTime,form.statusSearch);
            res.resultCode = ErrorCode.SUCCESS;
        } catch (Exception e) {
            res.resultCode = ErrorCode.INTERNAL_ERR;
            res.message = "系统错误";
    ...
    public Response reject(@RequestBody RejectBatchForm form) {
        ...
        try {
            ...
            for (String saleLeadsOrderId : form.saleLeadsOrderIdList) {
                // 调用hybris方法
                Object result = refreshStatus(saleLeadsOrderId);
            }
            res.data = i;
            res.resultCode = ErrorCode.SUCCESS;
    ...
    public Response addRemarks(@RequestBody AddRemarksForm form){
        ...
        try{
            ...
            refreshStatus(form.saleLeadsOrderId);
            res.resultCode=ErrorCode.SUCCESS;
        } catch(Exception e){
            res.resultCode=ErrorCode.INTERNAL_ERR;
            res.message="系统错误";
    ...
    public Response updateCustomerInfo(@RequestBody CustomerInfoForm form){
        ...
        try{
            ...
            res.data = i;
            refreshStatus(form.getId().toString());
            res.resultCode=ErrorCode.SUCCESS;
        } catch(Exception e){
            res.data = 0;
            res.resultCode=ErrorCode.INTERNAL_ERR;
    ...
    @ResponseBody
    public Response updateOrderProgress(@RequestBody SaleLeadOrderModelIn form){
        LogUtil.controllerLogInfo("{method:'SaleLeadsOrderController::updateOrderProgress',in:" + JSON.toJSONString(form) + "}");

        Response res = new Response();
        if (form.saleLeadsOrderId==null||StringUtils.isEmpty(form.statusName)||StringUtils.isEmpty(form.operatorBy)||StringUtils.isEmpty(form.orderEvaluation)) {
            res.resultCode=ErrorCode.INVALID_PARAM;
            res.message="参数错误";
            return res;
        }
        try{
            int i = saleLeadsOrderService.updateOrderProgress(form);
//            int i = saleLeadsOrderService.updateOrderProgress(form.statusName,form.saleLeadsOrderId,form.remark,form.operatorBy,form.failTypeId);
            ...
            res.data = i;
            refreshStatus(form.saleLeadsOrderId.toString());
            res.resultCode=ErrorCode.SUCCESS;
        } catch(Exception e){
            res.data = 0;
            res.resultCode=ErrorCode.INTERNAL_ERR;
    ...
    public Response updateSalOrderInfo(@RequestBody SalOrderInfoModelIn form){
        ...
        try{
            ...
            res.data = i;
            refreshStatus(form.getSaleLeadsOrderId().toString());//刷新状态~
            res.resultCode=ErrorCode.SUCCESS;
        } catch(Exception e){
            res.data = 0;
            res.resultCode=ErrorCode.INTERNAL_ERR;
     ...
     * 查询订单评价、流失情况、回访时间
     **/
    @RequestMapping(value = "/getStatusInfoById", method = {RequestMethod.POST,RequestMethod.GET},produces = "application/json")
    @ResponseBody
    public Response getStatusInfoById(@RequestBody  SalOrderInfoModelIn form) {
        LogUtil.controllerLogInfo("{method:'SaleLeadsOrderController::getStatusInfoById',in:" + JSON.toJSONString(form.getSaleLeadsOrderId()) + "}");
        Response result = new Response();
        if (form.getSaleLeadsOrderId()==null) {
            result.resultCode = ErrorCode.INVALID_PARAM;
            result.message = "参数错误";
            return result;
        }
        try {
            SaleLeadsOrderModel out = saleLeadsOrderService.getStatusInfoById(form.getSaleLeadsOrderId().toString());
            result.resultCode = ErrorCode.SUCCESS;
            result.data = out;
        } catch (Exception e) {
            LogUtil.controllerLogError(e.getMessage(), e);
        ...
        LogUtil.controllerLogInfo("{method:'SaleLeadsOrderController::getStatusInfoById',out:" + JSON.toJSONString(result) + "}");
        return result;
    }
