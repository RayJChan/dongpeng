 ...
 */
@Controller
@RequestMapping("/firstPageOfJsp")
public class FirstPageOfJspController {
	private static final Logger LOG = LoggerFactory.getLogger(FirstPageOfJspController.class);
	 ...
	 * 获取助销宝首页数据
	 */
	@RequestMapping(value = "/getFirstPageTest", method = { RequestMethod.GET,
